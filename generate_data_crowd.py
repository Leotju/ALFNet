...
ann = COCO(data_dir + 'annotations_new/train_20_02.json')
root_dir = 'data/crowd'
...
for type in types:
    ...
    print '{} has {} images and {} valid images, {} valid gt and {} ignored gt'.format(type, len(gts), valid_count,
                                                                                       box_count, iggt_count)
