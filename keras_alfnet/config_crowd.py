...
class Config:
	...
	def __init__(self):
		...
		# self.anchor_ratios = [[0.33, 0.4, 0.5, 0.67, 1.0], [0.33, 0.4, 0.5, 0.67, 1.0], [0.33, 0.4, 0.5, 0.67, 1.0], [0.33, 0.4, 0.5, 0.67, 1.0]]
		self.anchor_ratios = [[0.5], [0.5], [0.5], [0.5]]
